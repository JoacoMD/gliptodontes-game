        ...
        {LEARN_TOPICS.map((t) => (
          <li key={t.id}>
            <button
              ...
              className="w-full max-w-[350px] min-h-[96px] px-8 py-5 text-left transition-[transform,filter] duration-200 hover:scale-[1.04] hover:drop-shadow-[0_0_18px_rgba(255,193,107,0.85)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus"
            >
